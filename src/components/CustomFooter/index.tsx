...
export function CustomFooter() {
  ...
  return (
    <footer className="pb-[env(safe-area-inset-bottom)]">
      <hr className="border-gray-200 sm:mx-auto dark:border-gray-800 pt-5 max-sm:pt-10" />
      <div
        className={cn(
          "flex justify-center items-center gap-[2px] pd-5",
      ...
      >
        ...
        <div className="flex items-center gap-[2px]">
          ...
          <UnderlineLink
            link="https://github.com/three-dog-cloud"
            label={t("siteTitle")}
            underlineByDefault
          />
        </div>
